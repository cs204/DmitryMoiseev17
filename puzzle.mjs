...
// В сказал: "А - рыцарь."
let знания3 = new И()
знания3.добавить(new И (АРыцарь, new Не (АЛжец)))
знания3.добавить(new Эквивалентность (БРыцарь, new Не (БЛжец)))
знания3.добавить(new И (ВРыцарь, new Не (ВЛжец)))
знания3.добавить(new Эквивалентность(new И(АРыцарь, ВРыцарь), АРыцарь))
